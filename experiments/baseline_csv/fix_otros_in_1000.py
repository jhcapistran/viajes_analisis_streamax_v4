"""
CORRECCION: identity_id == "Otros" en trips_data_enriched_1000.csv
====================================================================

Mismo criterio aplicado antes a random_trips_data_2026_04.csv y
all_reviewed_trips_data_2026_07.csv: la etiqueta "Otros" en identity_id
NO es una identidad real, es una falla de FQA (el reviewer no pudo asignar
una cara valida). Se debe:
...
Procesa el CSV linea por linea con el modulo csv (no con pandas) para no
correr ningun riesgo de reformateo de floats/embeddings al reescribir
columnas que no se tocan. Crea un backup antes de escribir.

Uso:
    uv run python fix_otros_in_1000.py
"""
import csv
import os
import shutil
...
INPUT_FILE = os.path.join(REPO_ROOT, "data", "trips_data_enriched_1000.csv")
